        ...
        <>
            <Header/>
                <PageContent>
                    ...
                    <Text space={50} text={[
                        "Conectar clientes aos produtos químicos e serviços de importação, dentro de uma solução completa no fornecimento de produtos, tornando viável os processos empresariais ao longo de toda cadeia de suprimentos, contribuindo com o crescimento do mercado, o meio ambiente, saúde e bem-estar de toda a sociedade.",
                        "Ser uma empresa de referência no mercado que entrega uma solução completa no fornecimento de produtos químicos para pequenas medias e grandes empresas de forma regionalizada.",
                        "Acreditamos na importância das relações interpessoais respeitosa e colaborativa, como o pilar principal para o desenvolvimento de um ambiente saudável e duradouro. Ter um compromisso com a verdade é o melhor caminho para cultivar a qualidade dessas relações. Quanto maior a diversidade de um grupo, maior será sua sabedoria, vitalidade e riqueza.",
                    ]}/>
                </PageContent>
            <Footer/>
        </>
